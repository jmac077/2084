...
{
	map<wstring, LPDIRECT3DTEXTURE9>::iterator it = textures.begin();
	while (it != textures.end())
	{
		map<wstring, LPDIRECT3DTEXTURE9>::iterator tempIt = it;
		it++;
		LPDIRECT3DTEXTURE9 textureToDelete = tempIt->second;
		if (textureToDelete)
...
bool DirectXTextureManager::loadTileSetFromTexture(	wstring dir,
